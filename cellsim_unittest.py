...
test_matrix = [[cellsim_log.Cell(False) for i in range(10)] for j in range(10)]
...
tissue = cellsim_log.Tissue(10, 40, cellsim_log.Cancer)
tissue.seed_from_file('tt1.txt', cellsim_log.Cancer)
...
print("========== Next state==========")
print("=== Output Test ===")
input_test = cellsim_log.Tissue(10, 40, cellsim_log.Cancer)
input_test.seed_from_file('input_test', cellsim_log.Cancer)
print(input_test)
# for i in range(100):
#     print("time step", i)
...
output_test = cellsim_log.Tissue(10, 40, cellsim_log.Cell)
output_test = output_test.seed_from_file('output_test.txt', cellsim_log.Cell)
